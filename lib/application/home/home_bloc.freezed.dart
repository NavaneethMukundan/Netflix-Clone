...
mixin _$HomeState {
  ...
  List<HotAndNewData> get trendingMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get tensDramsMovieList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<HotAndNewData> tensDramsMovieList,
...
class _$HomeStateCopyWithImpl<$Res> implements $HomeStateCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? tensDramsMovieList = freezed,
    ...
    return _then(_value.copyWith(
      ...
      trendingMovieList: trendingMovieList == freezed
          ...
          : trendingMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      tensDramsMovieList: tensDramsMovieList == freezed
          ? _value.tensDramsMovieList
          : tensDramsMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
...
class _$_Initial implements _Initial {
  const _$_Initial(
      ...
      required final List<HotAndNewData> tensDramsMovieList,
      ...
      : _pastYearMovieList = pastYearMovieList,
        ...
        _tensDramsMovieList = tensDramsMovieList,
  ...
  final List<HotAndNewData> _tensDramsMovieList;
  @override
  List<HotAndNewData> get tensDramsMovieList {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_tensDramsMovieList);
  }
  ...
  @override
  String toString() {
    return 'HomeState(stateId: $stateId, pastYearMovieList: $pastYearMovieList, trendingMovieList: $trendingMovieList, tensDramsMovieList: $tensDramsMovieList, southIndianMovieList: $southIndianMovieList, trendingTvList: $trendingTvList, isLoading: $isLoading, hasError: $hasError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._tensDramsMovieList, _tensDramsMovieList) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_tensDramsMovieList),
